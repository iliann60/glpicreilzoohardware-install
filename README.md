...
Lancer l'installation avec la commande suivante : sudo perl glpi-agent-1.15-linux-installer.pl --server="https://maisonlancloud.freeboxos.fr:49151/front/inventory.php" --install
